...
function Nav() {
    ...
    return (
        <div className="max-w-1/2 w-full py-5 gap-20 items-center bg-white flex justify-center">
            ...
            <div className="me-5 justify-end gap-2 flex">
                <button className="px-6 py-3 rounded-[3px] border border-[#cee0f5] justify-center items-center gap-3 flex"
