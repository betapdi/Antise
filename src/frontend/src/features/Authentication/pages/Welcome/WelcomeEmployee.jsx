        ...
        <div className='w-2/3 flex justify-center items-center flex-col gap-3'>
            ...
            <div className="flex-col justify-center items-center gap-4 flex">
                <div className="text-center">
                    ...
                    <div className="">
                        <span style="text-[#5e6670] text-[32px] font-bold font-['Inter'] leading-10">We’re excited to have you on board. Here’s a quick guide to help you get started and make the most of your experiences:<br /></span>
                        <span style="text-[#5e6670] text-2xl font-bold font-['Inter'] leading-normal"><br /></span>
                        <span style="text-[#5e6670] text-2xl font-normal font-['Inter'] leading-10">Complete Your Profile 👤<br />Explore Opportunities Jobs 🔍<br />Job Alerts & Recommendations 🔔<br />Apply For A Job 📝<br />Track Your Applications 📈<br />Favorite A Job ❤️<br />Stay Active & Visible 👀</span>
                    </div>
