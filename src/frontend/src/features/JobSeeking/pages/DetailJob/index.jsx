...
function DetailJob() {
    ...
    return (
        <div>
                ...
                <div className='flex flex-row mt-20 w-full max-w-7xl gap-10'>
                    ...
                    <div className="flex-col justify-start items-start gap-8 inline-flex">
                        <div className="flex-col justify-start items-start gap-4 flex">
                            ...
                            <div className="w-[734px] text-[#5e6670] text-base font-normal font-['Inter'] leading-normal">Integer aliquet pretium consequat. Donec et sapien id leo accumsan pellentesque eget maximus tellus. Duis et est ac leo rhoncus tincidunt vitae vehicula augue. Donec in suscipit diam. Pellentesque quis justo sit amet arcu commodo sollicitudin. Integer finibus blandit condimentum. Vivamus sit amet ligula ullamcorper, pulvinar ante id, tristique erat. Quisque sit amet aliquam urna. Maecenas blandit felis id massa sodales finibus. Integer bibendum eu nulla eu sollicitudin. Sed lobortis diam tincidunt accumsan faucibus. Quisque blandit augue quis turpis auctor, dapibus euismod ante ultricies. Ut non felis lacinia turpis feugiat euismod at id magna. Sed ut orci arcu. Suspendisse sollicitudin faucibus aliquet.</div>
                            <div className="w-[734px] text-[#5e6670] text-base font-normal font-['Inter'] leading-normal">Nam dapibus consectetur erat in euismod. Cras urna augue, mollis venenatis augue sed, porttitor aliquet nibh. Sed tristique dictum elementum. Nulla imperdiet sit amet quam eget lobortis. Etiam in neque sit amet orci interdum tincidunt.</div>
                        </div>
                        <div className="flex-col justify-start items-start gap-4 flex">
                            <div className="text-black text-lg font-medium font-['Inter'] leading-7">Responsibilities</div>
                            <div className="flex-col justify-start items-start gap-3 flex">
                                <div className="w-[734px] text-[#5e6670] text-base font-normal font-['Inter'] leading-normal">Quisque semper gravida est et consectetur.</div>
                                <div className="w-[734px] text-[#5e6670] text-base font-normal font-['Inter'] leading-normal">Curabitur blandit lorem velit, vitae pretium leo placerat eget.</div>
                                <div className="w-[734px] text-[#5e6670] text-base font-normal font-['Inter'] leading-normal">Morbi mattis in ipsum ac tempus.</div>
                                <div className="w-[734px] text-[#5e6670] text-base font-normal font-['Inter'] leading-normal">Curabitur eu vehicula libero. Vestibulum sed purus ullamcorper, lobortis lectus nec.</div>
                                <div className="w-[734px] text-[#5e6670] text-base font-normal font-['Inter'] leading-normal">vulputate turpis. Quisque ante odio, iaculis a porttitor sit amet.</div>
                                <div className="w-[734px] text-[#5e6670] text-base font-normal font-['Inter'] leading-normal">lobortis vel lectus. Nulla at risus ut diam.</div>
                                <div className="w-[734px] text-[#5e6670] text-base font-normal font-['Inter'] leading-normal">commodo feugiat. Nullam laoreet, diam placerat dapibus tincidunt.</div>
                                <div className="w-[734px] text-[#5e6670] text-base font-normal font-['Inter'] leading-normal">odio metus posuere lorem, id condimentum erat velit nec neque.</div>
                                <div className="w-[734px] text-[#5e6670] text-base font-normal font-['Inter'] leading-normal">dui sodales ut. Curabitur tempus augue.</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex-col justify-start items-start gap-6 inline-flex">
                        <div className="p-8 bg-white rounded-lg border-2 border-[#e7f0fa] flex-col justify-start items-start gap-6 flex">
                            <div className="text-[#181f33] text-xl font-medium font-['Inter'] leading-loose">Job Overview</div>
                            <div className="justify-start items-start gap-5 inline-flex">
                                <div className="flex-col justify-start items-start gap-4 inline-flex">
                                    ...
                                    <div className="flex-col justify-start items-start gap-1 flex">
                                        <div className="w-36 text-[#767f8c] text-xs font-normal font-['Inter'] uppercase leading-[18px]">Job Posted:</div>
                                        <div className="w-36 text-[#18191c] text-sm font-medium font-['Inter'] leading-tight">14 June, 2021</div>
                                    </div>
                                </div>
                                <div className="flex-col justify-start items-start gap-4 inline-flex">
                                    <div className="w-8 h-8 justify-center items-center inline-flex">
                                    ...
                                    <div className="flex-col justify-start items-start gap-1 flex">
                                        <div className="w-36 text-[#767f8c] text-xs font-normal font-['Inter'] uppercase leading-[18px]">Job expire in:</div>
                                        <div className="w-36 text-[#18191c] text-sm font-medium font-['Inter'] leading-tight">14 July, 2021</div>
                                    </div>
                                </div>
                                <div className="flex-col justify-start items-start gap-4 inline-flex">
                                    <div className="w-8 h-8 relative">
                                    ...
                                    <div className="flex-col justify-start items-start gap-1 flex">
                                        <div className="w-36 text-[#767f8c] text-xs font-normal font-['Inter'] uppercase leading-[18px]">Education</div>
                                        <div className="w-36 text-[#18191c] text-sm font-medium font-['Inter'] leading-tight">Graduation</div>
                                    </div>
                                </div>
                            </div>
                            <div className="justify-start items-start gap-5 inline-flex">
                                <div className="flex-col justify-start items-start gap-4 inline-flex">
                                    ...
                                    <div className="flex-col justify-start items-start gap-1 flex">
                                        <div className="w-36 text-[#767f8c] text-xs font-normal font-['Inter'] uppercase leading-[18px]">Salery:</div>
                                        <div className="w-36 text-[#18191c] text-sm font-medium font-['Inter'] leading-tight">$50k-80k/month</div>
                                    </div>
                                </div>
                                <div className="flex-col justify-start items-start gap-4 inline-flex">
                                    <div className="w-8 h-8 justify-center items-center inline-flex">
                                    ...
                                    <div className="flex-col justify-start items-start gap-1 flex">
                                        <div className="w-36 text-[#767f8c] text-xs font-normal font-['Inter'] uppercase leading-[18px]">LOCATIOn:</div>
                                        <div className="w-36 text-[#18191c] text-sm font-medium font-['Inter'] leading-tight">New York, USA</div>
                                    </div>
                                </div>
                                <div className="flex-col justify-start items-start gap-4 inline-flex">
                                    <div className="w-8 h-8 relative">
                                    ...
                                    <div className="flex-col justify-start items-start gap-1 flex">
                                        <div className="w-36 text-[#767f8c] text-xs font-normal font-['Inter'] uppercase leading-[18px]">job type:</div>
                                        <div className="w-36 text-[#18191c] text-sm font-medium font-['Inter'] leading-tight">Full Time</div>
                                    </div>
                                </div>
                            </div>
                            <div className="flex-col justify-start items-start gap-4 flex">
                                ...
                                <div className="flex-col justify-start items-start gap-1 flex">
                                    <div className="w-36 text-[#767f8c] text-xs font-normal font-['Inter'] uppercase leading-[18px]">Experience</div>
                                    <div className="w-36 text-[#18191c] text-sm font-medium font-['Inter'] leading-tight">10-15 Years</div>
                                </div>
                            </div>
                        </div>
                        <div className="p-8 rounded-xl border-2 border-[#e7f0fa] flex-col justify-start items-start gap-8 flex">
                            <div className="justify-start items-center gap-4 inline-flex">
                                <img className="p-5 rounded-md" src="https://via.placeholder.com/64x64" />
                            ...
                            <div className="flex-col justify-start items-start gap-4 flex">
                                <div className="w-[472px] justify-between items-center inline-flex">
            ...
            {/* Related Jobs */}
            <div className="flex flex-col justify-center items-center bg-white shadow-inner gap-[10px] w-full">
                <div className="w-[1320px] flex justify-between items-center mb-10">
